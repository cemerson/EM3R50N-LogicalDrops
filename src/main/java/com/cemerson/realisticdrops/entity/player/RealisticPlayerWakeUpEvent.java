package com.cemerson.realisticdrops.entity.player;
//package com.cemerson.realisticdrops.entity.player;
//
//import net.minecraft.entity.player.EntityPlayer;
//import net.minecraftforge.event.entity.player.PlayerEvent;
//
//public class RealisticPlayerWakeUpEvent extends PlayerEvent{
//	
////	/**
////     * Used for the 'wake up animation'.
////     * This is false if the player is considered 'sleepy' and the overlay should slowly fade away.
////     */
////    public final boolean wakeImmediatly = false;
////
////    /**
...
//
//    //, boolean wakeImmediatly, boolean updateWorld, boolean setSpawn)
//	// PlayerWakeUpEvent
