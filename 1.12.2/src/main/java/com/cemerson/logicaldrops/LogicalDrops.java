...
public class LogicalDrops {
    ...
    public static int intLlamaBoneMax;
    public static int intLlamaBoneMin;
    public static int intLlamaLeatherMax;
    public static int intLlamaLeatherMin;     
    public static int intLlamaMeatMax;
    public static int intLlamaMeatMin;    
    ...
    public static int intPigBoneMax;
    public static int intPigBoneMin;
    ...
    public static void syncConfig() {
        ...
        intCowLeatherMax = configFile.get(Configuration.CATEGORY_GENERAL, "CowLeatherMax", 4).getInt();
        intCowLeatherMin = configFile.get(Configuration.CATEGORY_GENERAL, "CowLeatherMin", 2).getInt();                
        ...
        intHorseBoneMax = configFile.get(Configuration.CATEGORY_GENERAL, "HorseBoneMax", 10).getInt();
        intHorseBoneMin = configFile.get(Configuration.CATEGORY_GENERAL, "HorseBoneMin", 6).getInt();
        intHorseLeatherMax = configFile.get(Configuration.CATEGORY_GENERAL, "HorseLeatherMax", 12).getInt();
        intHorseLeatherMin = configFile.get(Configuration.CATEGORY_GENERAL, "HorseLeatherMin", 6).getInt();                
        ...
        intLlamaBoneMax = configFile.get(Configuration.CATEGORY_GENERAL, "LlamaBoneMax", 8).getInt();
        intLlamaBoneMin = configFile.get(Configuration.CATEGORY_GENERAL, "LlamaBoneMin", 4).getInt();
        intLlamaLeatherMax = configFile.get(Configuration.CATEGORY_GENERAL, "LlamaLeatherMax", 10).getInt();
        intLlamaLeatherMin = configFile.get(Configuration.CATEGORY_GENERAL, "LlamaLeatherMin", 5).getInt();                
        intLlamaMeatMax = configFile.get(Configuration.CATEGORY_GENERAL, "LlamaMeatMax", 10).getInt();
        intLlamaMeatMin = configFile.get(Configuration.CATEGORY_GENERAL, "LlamaMeatMin", 6).getInt();                
        ...
        intPigBoneMax = configFile.get(Configuration.CATEGORY_GENERAL, "PigBoneMax", 4).getInt();
        intPigBoneMin = configFile.get(Configuration.CATEGORY_GENERAL, "PigBoneMin", 2).getInt();
        ...
        intCreeperLeavesMax = configFile.get(Configuration.CATEGORY_GENERAL, "CreeperLeavesMax", 0).getInt();
        intCreeperLeavesMin = configFile.get(Configuration.CATEGORY_GENERAL, "CreeperLeavesMin", 0).getInt();        
